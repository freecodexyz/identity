...
const DEFAULT_WORKFLOW_REF = "freecodexyz/identity/.github/workflows/register.yml@refs/heads/main";
...
const jobWorkflowRef = fixture.jobWorkflowRef ?? DEFAULT_WORKFLOW_REF;
...
const workflowName = fixture.workflowName ?? "Register Identity";
...
const payload = {
  ...
  sub: `repo:freecodexyz/identity:ref:refs/heads/main`,
  aud: wallet,
  workflow: workflowName,
  ref: "refs/heads/main",
  sha: "0000000000000000000000000000000000000000",
  repository: "freecodexyz/identity",
  repository_owner: "freecodexyz",
